...
<div class="container-fluid px-4 py-5">
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="bg-gradient-danger rounded-4 p-4 text-white shadow-lg">
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        ...
                        <p class="lead mb-0 opacity-90">Gestion des abonnements en attente de paiement</p>
                    </div>
                    <div class="text-end">
    ...
    <div class="alert alert-warning border-0 shadow-sm mb-4 text-center" style="max-width: 400px; margin: 0 auto;">
        ...
        Clients Actifs Non Payés : <strong>{{ $nonPayes }}</strong>
    </div>
    ...
    @if ($clients->isEmpty())
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center p-5">
                ...
                <h4 class="text-muted">Aucun client non payé trouvé</h4>
                <p class="text-muted mb-4">Tous les clients ont régularisé leur situation ou aucun client n'est enregistré</p>
                ...
                const noResultsHtml = `
                    <tr id="noResultsRow">
                        <td colspan="10" class="text-center py-5 text-muted">
                            ...
                            <p class="mb-0">Aucun client non payé trouvé pour "<strong>${value}</strong>"</p>
                        </td>
                    </tr>
                `;
